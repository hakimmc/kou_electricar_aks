...
char* cf2a(float num,char str[4]){//Çalışıyor
	num+=33.33;
	str[0] = (char)(int)(num);
	str[1] = '.';
	str[2] = (char) (((int)(num*100.0))-(100*((int)num)));
